...
class DiscountDelivery extends Component {
  constructor(props) {
    super(props);
    this.state = {
      min_order_value: 0,
  ...
  componentDidMount() {
    this.props.getDiscountData({ order_type: "DELIVERY", });
  }
            ...
            <div className="table-responsive table1div">
              <table className="table table-bordered table-sm">
                ...
                <tbody>
                  ...
                  {DiscountReducerData && DiscountReducerData.DeliveryCardData &&
                    DiscountReducerData.DeliveryCardData.length ? (
                    DiscountReducerData.DeliveryCardData.map((itm, ind) => {
                      return (
                        <tr
                          key={ind}
                          onClick={() =>
                                ...
                                <CBadge
                                  ...
                                  onClick={() => this.setState({ selectRowId: itm._id, selectRowClick: 1 }, () =>
                                    this.props.onUpdateData(
                                      {
                                        is_deleted: false,
                                        condition_id: itm._id, order_type: "DELIVERY",
                                      }
                                    )
                                  )}
                                >
...
export default connect(mapStateToProps, mapDispatchToProps)(DiscountDelivery);