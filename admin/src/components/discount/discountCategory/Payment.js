...
class PAYMENT_TYPE extends Component {
    constructor(props) {
        super(props);
        this.state = {
            discount: "",
    ...
    componentDidMount() {
        this.props.getCardDiscountData({ discount_type: "PAYMENT_TYPE" });
    }
            ...
            <>
                <CCard>
                    <CCardHeader className="d-flex flex-row justify-content-between">
                        {" "}
                        <h6><i class="fas fa-list-alt mr-2" />Payment Type</h6>
                        <div>
                            ...
                            <table className="table table-bordered table-sm">
                                ...
                                <tbody>
                                    ...
                                    {DiscountCategoryReducerData && !DiscountCategoryReducerData.isLoading ?
                                        DiscountCategoryReducerData.payment &&
                                            DiscountCategoryReducerData.payment.length ? (
                                            DiscountCategoryReducerData.payment.map((itm, ind) => {
                                                return (
                                                    <tr
                                                        key={ind}
...
export default connect(mapStateToProps, mapDispatchToProps)(PAYMENT_TYPE);
