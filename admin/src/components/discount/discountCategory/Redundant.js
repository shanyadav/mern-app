...
class REDUNDANT_CART extends Component {
    constructor(props) {
        super(props);
        this.state = {
            discount: "",
    ...
    componentDidMount() {
        this.props.getCardDiscountData({ discount_type: "REDUNDANT_CART" });
    }
    ...
    onUpdateData = () => {
        ...
        this.props.onUpdateData({
            ...
            type: type,
            expiry_time: parseFloat(expiry_time),
        });
            ...
            <>
                <CCard>
                    <CCardHeader className="d-flex flex-row justify-content-between">
                        {" "}
                        <h6><i class="fas fa-list-alt mr-2" />REDUNDANT CART</h6>
                        <div>
                            ...
                            <table className="table table-bordered table-sm">
                                <thead className="table1header">
                                    <tr>
                                        ...
                                        <th className="td2">Expiry Time </th>
                                ...
                                <tbody>
                                    ...
                                    {DiscountCategoryReducerData && !DiscountCategoryReducerData.isLoading ?
                                        DiscountCategoryReducerData.redundant &&
                                            DiscountCategoryReducerData.redundant.length ? (
                                            DiscountCategoryReducerData.redundant.map((itm, ind) => {
                                                return (
                                                    <tr
                                                        key={ind}
                                                    ...
                                                    >
                                                        ...
                                                        <td>
                                                            {selectRowId === itm._id && selectRowClick > 1 ? (
                                                                ...
                                                                <span>{itm.expiry_time} hours</span>
                                                            ) : null}
                                                        </td>
...
export default connect(mapStateToProps, mapDispatchToProps)(REDUNDANT_CART);
