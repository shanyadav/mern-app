...
class Paypal extends Component {
    ...
    componentDidMount() {
        this.props.getCardData({ type: "STRIPE" });
    }
            ...
            <>
                <CCard>
                    <CCardHeader className="d-flex flex-row justify-content-between">
                        {" "}
                        <h6><i class="fas fa-money-bill-alt mr-2 mt-4"></i>STRIPE PAYMENT GETEWAY</h6>
                    </CCardHeader>
                    ...
                    <CCardBody>
                        ...
                        <div className="table-responsive mt-3">
                            <table className="table table-bordered table-sm">
                                ...
                                <tbody>
                                    {PaymentGetwayReducerData &&
                                        PaymentGetwayReducerData.stripeData &&
                                        PaymentGetwayReducerData.stripeData.length ? (
                                        PaymentGetwayReducerData.stripeData.map((itm, ind) => {
                                            return (
                                                <tr
                                                    key={ind}
