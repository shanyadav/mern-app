...
export const foodTypeActions = {
  ...
  UPDATE_FOODTYPESTATUS_REQUEST: "UPDATE FOODTYPESTATUS REQUESTED!",
  UPDATE_FOODTYPESTATUS_SUCCESS: "UPDATE FOODTYPESTATUS SUCCESS!",
  UPDATE_FOODTYPESTATUS_FAILED: "UPDATE FOODTYPESTATUS FAILED!",
...
export const updateFoodTypesStatusRequest = createAction(
  foodTypeActions.UPDATE_FOODTYPESTATUS_REQUEST
);

export const updateFoodTypesStatusSuccess = createAction(
  foodTypeActions.UPDATE_FOODTYPESTATUS_SUCCESS
);
export const updateFoodTypesStatusFailed = createAction(
  foodTypeActions.UPDATE_FOODTYPESTATUS_FAILED
);
