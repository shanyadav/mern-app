...
export const subCategoriesActions = {
  ...
  UPDATE_SUBCATEGORY_ORDER_REQQUEST:"UPDATE SUBCATEGORY ORDER REQQUESTED!",
  UPDATE_SUBCATEGORY_ORDER_SUCCESS:"UPDATE SUBCATEGORY ORDER SUCCESS!",
  UPDATE_SUBCATEGORY_ORDER_FAILED:"UPDATE SUBCATEGORY ORDER FAILED!",
};
...
export const updateSubCategoryOrderRequest = createAction(
  subCategoriesActions.UPDATE_SUBCATEGORY_ORDER_REQQUEST
);
export const updateSubCategoryOrderSuccess = createAction(
  subCategoriesActions.UPDATE_SUBCATEGORY_ORDER_SUCCESS
);
export const updateSubCategoryOrderFailed = createAction(
  subCategoriesActions.UPDATE_SUBCATEGORY_ORDER_FAILED
);
