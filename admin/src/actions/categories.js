...
export const categoriesActions = {
  ...
  UPDATE_CATEGORY_ORDER_REQQUEST:"UPDATE CATEGORY ORDER REQQUESTED!",
  UPDATE_CATEGORY_ORDER_SUCCESS:"UPDATE CATEGORY ORDER SUCCESS!",
  UPDATE_CATEGORY_ORDER_FAILED:"UPDATE CATEGORY ORDER FAILED!",
...
export const updateCategoryOrderRequest = createAction(
  categoriesActions.UPDATE_CATEGORY_ORDER_REQQUEST
);
export const updateCategoryOrderSuccess = createAction(
  categoriesActions.UPDATE_CATEGORY_ORDER_SUCCESS
);
export const updateCategoryOrderFailed = createAction(
  categoriesActions.UPDATE_CATEGORY_ORDER_FAILED
);
